                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="input-container">
                                                ...
                                                <label for="nameInput" class="input-title">Date From</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="input-container">
                                                <input type="text" class="input-box" id="nameInput" placeholder=" ">
                                                <label for="nameInput" class="input-title">Date To</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="input-container">
                                                <input type="text" class="input-box" id="nameInput" placeholder=" ">
                                                <label for="nameInput" class="input-title">Member Name</label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tr>
                                                ...
                                                <div class="progress-wrapper w-50 mx-auto">
                                                    <div class="progress-info">
                                                        <div class="progress-percentage">
                                                            <span class="text-xs font-weight-bold">12 December 2023</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-right">
                                                <div class="progress-wrapper w-50 mx-auto">
                                                    <div class="progress-info">
                                                        <div class="progress-percentage">
                                                            <span class="text-xs font-weight-bold">12 December 2024</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-right">
                                                <div class="progress-wrapper w-50 mx-auto">
                                                    <div class="progress-info">
                                                        <div class="progress-percentage">
                                                            <span class="text-xs font-weight-bold">10 December 2023</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-right">
                                                <div class="progress-wrapper w-50 mx-auto">
                                                    <div class="progress-info">
                                                        <div class="progress-percentage">
                                                            <span class="text-xs font-weight-bold">10 December 2024</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
