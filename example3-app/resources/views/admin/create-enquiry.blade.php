                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{ asset('img/personal-information.png')}}" alt="profile_image"
                                ...
                                <div class="col-lg-12 col-md-6 col-sm-12" style="margin-top: 40px;">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="input-container">
                                                <input type="text" class="input-box" id="nameInput" placeholder=" ">
                                                <label for="nameInput" class="input-title">Enquiry Training Type</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="input-container">
                                                <input type="text" class="input-box" id="nameInput" placeholder=" ">
                                                <label for="nameInput" class="input-title">Select About Joining</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="input-container">
                                                <input type="text" class="input-box" id="nameInput" placeholder=" ">
                                                <label for="nameInput" class="input-title">Follow-up Date</label>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="container-fluid" style="margin-top: -30px;">
            ...
            <div class="card card-body blur shadow-blur mx-4 mt-6 overflow-hidden">
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{ asset('img/support.png')}}" alt="profile_image"
                                class="w-100 border-radius-lg shadow-sm">
                        </div>
                    </div>
                    <div class="col-auto my-auto">
                                    ...
                                    <div class="contact-form">
                                        <form id="contact" action="" method="get">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-12 col-sm-12">
                                                    <div class="input-container">
                                                        <input type="text" class="input-box" id="nameInput"
                                                            placeholder=" ">
                                                        <label for="nameInput" class="input-title">Source</label>
                                                    </div>
                                                </div>
                                            </div>
