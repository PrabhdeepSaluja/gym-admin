  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <div class="container-fluid">
      ...
      <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
              ...
              <div class="col-lg-12 col-md-6 col-sm-12" style="margin-top: 40px;">
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                      <div class="input-container">
                        <input type="text" class="input-box" id="nameInput" placeholder=" ">
                        <label for="nameInput" class="input-title">Rate</label>
                      </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12">
                      <div class="input-container">
                        <input type="text" class="input-box" id="nameInput" placeholder=" ">
                        <label for="nameInput" class="input-title">Validity</label>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row mt-4">
                  <div class="col-lg-4 col-md-12 col-sm-12">
                      <div class="input-container">
                        <input type="text" class="input-box" id="nameInput" placeholder=" ">
                        <label for="nameInput" class="input-title">Details</label>
                      </div>
                    </div>
        ...
        <div class="text-left">
            <button type="button" class="btn bg-gradient-dark w-30 my-6 mx-2 mb-4">Submit</button>
        </div>
    </div>
    </div>
