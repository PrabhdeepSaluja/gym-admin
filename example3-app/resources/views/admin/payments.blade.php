...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/create-training') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Personal Training</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{ asset('img/examination.png')}}" alt="profile_image"
                    ...
                    <div class="col-lg-12 col-md-12 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-4"
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th
                                                class="text-center text-uppercase text-secondary text-sm font-weight-bolder opacity-7">
                                                MEMBERSHIP START DATE</th>
                                            <th
                                                class="text-center text-uppercase text-secondary text-sm font-weight-bolder opacity-7">
                                                MEMBERSHIP END DATE</th>
                                            <th
                                                class="text-center text-uppercase text-secondary text-sm font-weight-bolder opacity-7">
                                                ACTION</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="align-right text-sm">
                                                <span class="badge badge-sm bg-gradient-info"
                                                    style="width: 40%;">10000</span>
                                            </td>
                                            <td class="align-right">
                                                <div class="progress-wrapper w-50 mx-auto">
                                                    <div class="progress-info">
                                                        <div class="progress-percentage">
                                                            <span class="text-xs font-weight-bold">12 December
                                                                2023</span>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-right">
                                                <div class="progress-wrapper w-50 mx-auto">
                                                    <div class="progress-info">
                                                        <div class="progress-percentage">
                                                            <span class="text-xs font-weight-bold">1 January 2024</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-sm">
                                                <h6 class="mb-0 text-sm">Lance</h6>
                                            </td>
                                            <td class="align-left text-sm">
                                                <span class="text-xs font-weight-bold">Personal Training</span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm bg-gradient-success"
                                                    style="width: 40%;">10000</span>
                                            ...
                                            <td class="align-right">
                                                <div class="progress-wrapper w-50 mx-auto">
                                                    <div class="progress-info">
                                                        <div class="progress-percentage">
                                                            <span class="text-xs font-weight-bold">10 December
                                                                2024</span>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <script>
    var ctx = document.getElementById("chart-bar                    getContext("2d                                             art(ctx                                type                    
      data: {
        labels: ["Apr",                    "Jun", "Jul",                        ep",                                    ov", "Dec"]                                      datas                                                                 : "Sales",
                                       ension: 0.4,
                                         derWidth: 0,
                            erR                                                                                     fa                         ba                                    lo                    ",
          data: [450, 200                    20, 500                                                                  
    ...
    var ctx2 =                        getElementBy                        lin            getContext("2d");

    var gradientS                        tx2.createLinearGra                                            ,                            gradientStroke1.                        op(1, 'r                              12,159,0.2)');
                         tStroke1.addColo                         '            (72,72,176                           gradientStrok                        rStop(0, 'rgba(203,12,159,                                rple colors
                        radientStroke2 = ctx2.createLinearGra            t                        , 50);

    gradien                    .ad                    op(                                   a(20,23,39,                        gradientStroke                    orStop(0.2, '            (72                    0.0)');
                           troke2.add                             'rgba(20,23,39,                                              le                                                            tx2,                                                                                                
        l                        pr",                             , "Jul",                                                                                                                                  ets: [{
                                                   obile apps",
                                           ension: 0                                                               derWi                                                                               : 0,
                                                     : "#c                                                                            Width: 3,
                                       ...
                                       40                            50                                                     , 2                                                                       rTh                                                                                             {
                                           ...
                                           ension: 0.4,
                                             ...
                                             ntRa                                     b                                            "#3A416F",
                                                                                                                                               ie                                                                                                 data:                                 40,                                                                             400                                                                : 6                                                ],
                           options: {
                                 ponsive: true                      maint                                          atio: fal                          plugins:                                        en {
                      pl                    e,
                      }
        },
                        teraction: {
        ...
        <script>
    var win = navigator.pla            m.indexOf('Win') > -1;
    if (win && document.querySelecto                denav-scrollbar'                       var options                                   mping: '0.5'
      }
      Scrollbar.init(document.querySelector('#side            scllbar')ns);
    }
        </script>
        <!-- Github buttons -->
